...
var _private_setupLoginFormClient = function (_doc){
     if(!_doc){var _doc = document; }
        ...
        posting.done(function( data ) {
            betaStudio_module_client.userdata.snoop_var_username = "";
            betaStudio_module_client.userdata.snoop_var_user_type = "";
            betaStudio_module_client.userdata.snoop_var_last_authentication_status = "checked";
        ...
        if(data.indexOf("success")> -1){
            betaStudio_module_clientbetaStudio_module_clientbetaStudio_module_client.snoop_var_username = data.split("||")[1];
            betaStudio_module_clientbetaStudio_module_client.snoop_var_user_type = data.split("||")[2];
            betaStudio_module_client.snoop_var_last_authentication_status = "login_attempted";
            _private_Update_authentication_ui();
        }else if(data.indexOf("loggedin")> -1){
            betaStudio_module_client.userdata.snoop_var_username = data.split("||")[1];
            betaStudio_module_client.userdata.snoop_var_user_type = data.split("||")[2];
            betaStudio_module_client.userdata.snoop_var_last_authentication_status = "checked";
         _private_Update_authentication_ui();
        }else if(data.indexOf("failed")> -1){
            betaStudio_module_client.userdata.snoop_var_username = data.split("||")[1];
            betaStudio_module_client.userdata.snoop_var_user_type = data.split("||")[2];
            betaStudio_module_client.userdata.snoop_var_last_authentication_status = "login_attempted";
         _private_Update_authentication_ui();
...
var _private_HideLogin = function (){$("#"+config.loginModal).hide();}
 var _private_Update_authentication_ui = function (){
     ...
     if(betaStudio_module_client.userdata.snoop_var_username == ""){
        ...
        }else if(betaStudio_module_client.userdata.snoop_var_username != ""){  
         $( "#"+config.usernameLabelinHeader).empty().append( betaStudio_module_client.userdata.snoop_var_username );
         $( "#"+config.logoutLoginLabelinHeader ).empty().append( "<span onclick='betaStudio_module_client_authentication.Logout()'>Logout</span>" );
            _private_HideLogin();
        }else {
         $( "#"+config.usernameLabelinHeader).empty().append( "Guest" );
         $( "#"+config.logoutLoginLabelinHeader ).empty().append( "<span onclick='betaStudio_module_client_authenticationbetaStudio_module_client_authentication.Login()'>Login</span>" ); 
             _private_ShowLogin();
        }
     if(betaStudio_module_client.userdata.snoop_var_last_authentication_status == "login_attempted" && betaStudio_module_client.userdata.snoop_var_username == "" ){
...
var _private_Logout = function (){
            ...
            var posting = $.post( url, { username: betaStudio_module_client.userdata.snoop_var_username    } );
            // Put the results in a div
            posting.done(function( data ) {
            betaStudio_module_client.userdata.snoop_var_username = "";
            betaStudio_module_client.userdata.snoop_var_user_type = "";
            ...
            betaStudio_module_client.userdata.snoop_var_username = "";
            betaStudio_module_client.userdata.snoop_var_user_type = "";
            betaStudio_module_client.userdata.snoop_var_last_authentication_status = "loggedout";
